 <?php
	...
	$sql = mysqli_query($koneksi, "SELECT pemasok.nama_pemasok,barang.nama_barang,barang.jumlah,barang.id_produk,barang.created_at FROM barang INNER JOIN pemasok ON pemasok.id_pemasok=barang.id_pemasok");
 ...
 <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 	...
 	<a href="Tambah_barang.php" class="btn btn-sm btn-primary">Tambah Barang</button></a>
 	<br><br>
 				...
 				<?php
					...
					while ($rs = mysqli_fetch_assoc($sql)) : ?>
 					<tr>
 						...
 						<td><?= $rs['created_at']; ?></td>
 						<td>
 							<a href="ubah_barang1.php?id=<?= $rs['id_barang']; ?>" class="btn btn-primary btn-sm">Ubah</a>
